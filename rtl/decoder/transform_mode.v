...
wire [6:0] qp [2:0];
wire signed [13:0] neighborsAbove_from_ram [2:0][15:0]; // spec Fig 4-13: A-4, A-3, A-2, A-1, A0, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11
...
always @ (*) 
  for (c=0; c<3; c=c+1) begin
    ...
    else begin// (blkWidth[c] == 4'd4) & (blkHeight[c] == 2'd2)
      for (k=0; k<2; k=k+1)
